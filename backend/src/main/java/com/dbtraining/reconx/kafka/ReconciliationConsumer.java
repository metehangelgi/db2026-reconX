...
public class ReconciliationConsumer {
    ...
    public void onTradeEvent(TradeEvent event) {
        ...
        // NOTE: intentionally does not reconcile inline or write to recon_jobs here —
        // that would block the consumer thread and back up the Kafka partition.
        // A full async job-enqueue implementation is out of scope for this ticket.
    }
}
